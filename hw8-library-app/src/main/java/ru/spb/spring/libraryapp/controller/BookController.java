...
public class BookController {
    ...
    public void addGenreToBook(String bookId, String genreName) {
        bookService.addGenre(bookId, Genre.builder().name(genreName).build());

        System.out.println(format("Genre(genreName=%s) was successfully add to book with id=%s", genreName, bookId));
    }
    ...
    public void deleteGenre(String bookId, String genreName) {
        bookService.deleteGenre(bookId, genreName);

        System.out.println(format("Genre(genreName=%s) was successfully removed from book with id=%s", genreName, bookId));
    }
