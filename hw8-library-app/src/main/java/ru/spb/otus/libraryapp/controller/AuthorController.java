...
public class AuthorController {
    ...
    public void findById(@ShellOption("--id") String id) {
    ...
    public void update(@ShellOption("--id") String id, @ShellOption("--f") String firstName, @ShellOption("--l") String lastName, @ShellOption("--p") String patronymic) {
